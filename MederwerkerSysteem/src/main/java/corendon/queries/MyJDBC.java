...
public class MyJDBC {
    ...
    private final static String DB_DRIVER_PARAMETERS = "?useSSL=false&serverTimezone=UTC";
    ...
    public final void close() {
        ...
        try {
            ...
            this.log("Database has been closed");
        } catch (SQLException eSQL) {
            error(eSQL);
        }
    }
    ...
    /**
     * *
     * Executes prepared statement query that is expected to return no value
     *
     * @param sql the full sql text of the query.
     * @return the string result, null if no result or error
     */
    public void executePreparedStatementQuery(PreparedStatement preparedStmt) {
        try {
    ...
    /**
     * *
     * Executes preparest statement update query that is expected to return no
     * value
     *
     * @param sql the full sql text of the query.
     * @return the string result, null if no result or error
     */
    public void executePreparedStatementUpdateQuery(PreparedStatement preparedStmt) {
        // String result = null;
        try {
            //Statement s = this.connection.createStatement();
            //log(sql);
